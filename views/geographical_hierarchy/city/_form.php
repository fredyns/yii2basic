    ...
    <div class="">
        <div class="">
            ...
            // generated by app\generators\crud\providers\RelationProvider::activeField
                ...
                ->widget(\kartik\select2\Select2::class, [
                    ...
                    'pluginOptions' => [
                        ...
                        'ajax' => [
                            'url' => \yii\helpers\Url::to(['/api/geographical-hierarchy/country/select2-options']),
                            'dataType' => 'json',
                            'data' => new \yii\web\JsExpression('function(params) { return {q:params.term}; }')
                        ],
                        'escapeMarkup' => new \yii\web\JsExpression('function (markup) { return markup; }'),
            ...
            // generated by app\generators\crud\providers\RelationProvider::activeField
                ...
                ->widget(\kartik\select2\Select2::class, [
                    'initValueText' => \yii\helpers\ArrayHelper::getValue($model, 'region.name', $model->region_id),
                    'options' => ['placeholder' => Yii::t('app', 'searching...')],
                    'pluginOptions' => [
                        'allowClear' => true,
                        'tags' => false,
                        ...
                        'ajax' => [
                            'url' => \yii\helpers\Url::to(['/api/geographical-hierarchy/region/select2-options']),
                            'dataType' => 'json',
                            'data' => new \yii\web\JsExpression('function(params) { return {q:params.term}; }')
                        ],
                        'escapeMarkup' => new \yii\web\JsExpression('function (markup) { return markup; }'),
