...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var app\lib\sample\person\index\PersonSearch $searchModel
*/

$this->title = Yii::t('sample', 'People');
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            [
                'url' => ['user/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('sample', 'User'),
            ],
                                [
                'url' => ['user/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('sample', 'User'),
