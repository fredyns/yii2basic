...
/* @var $searchModel SubdistrictSearch */

$this->title = Yii::t('app/geo_address/texts','Subdistrict Archives');
$this->params['breadcrumbs'][] = Yii::t('app/geo_address/texts', 'Geo Address');
$this->params['breadcrumbs'][] = ['label' => $model->modelLabel(true), 'url' => ['index']];
$this->params['breadcrumbs'][] = Yii::t('cruds', 'Archives');
?>

<div class="app-crud subdistrict-archive">
