    ...
    public function generateMetaBasic()
    {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            $this->metadata[$tableName] = [
                ...
                'className' => $className,
                'queryNameSpace' => ($this->generateQuery) ? ArrayHelper::getValue($this->nameSpaces, $tableName, $this->ns) : false,
                'queryBaseClass' => ($this->generateQuery) ? $this->queryBaseClass : false,
